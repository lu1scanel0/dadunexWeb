...
declare const CreateEmailIdentityCommand_base: {
    new (input: CreateEmailIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailIdentityCommandInput, CreateEmailIdentityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEmailIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailIdentityCommandInput, CreateEmailIdentityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
